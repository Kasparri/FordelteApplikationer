...
public class Hello_02148 {
	...
	public class Template {
		...
		// Blocking operation to check the existence of a file matching a template
		// The template is updated with the matched values for the tuple arguments that were binders (i.e. "?")
	...
	public static void main(String[] args) throws IOException, DbxException {
		...
		final String accessToken = "2IXvlsnWAFAAAAAAAAAABuLDJo99GhZW7g6zWQZbVIZ8m7n84S7loiawkdMZcJzE";
